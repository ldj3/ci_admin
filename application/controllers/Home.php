...
class Home extends My_Controller {
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('icons/font_awesome',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('icons/glyphicons',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('maps/maps_google',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('maps/maps_vector',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/blank',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/sidebar_closed',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/coming_soon',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/blog',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/about_us',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('samplepages/contact_us',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('extra/lock',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('extra/profile',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('extra/invoice',$data);
		$this->load->view('_footer',$data);
	}
    ...
    {
		$data['title'] = '后台首页';
		$this->load->view('extra/pricing_tables',$data);
		$this->load->view('_footer',$data);
	}
